...
I want to get better at working with LLMs as a real collaborator on iterative technical work, the sort of back-and-forth, fine-tune-every-detail process this rubric itself just went through tonight, which reminded me a lot of my experience on SSMLA. I'm comfortable across most mainstream languages and would rather pick up what a repo already uses than stay in one lane.
